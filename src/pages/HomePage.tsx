...
export default function HomePage() {
  ...
  <div id="hero" data-section="hero">
    <SectionErrorBoundary name="hero">
          <HeroCenteredLogos
      avatarsSrc={[
        "http://img.b2bpic.net/free-photo/close-up-shot-amused-enthusiastic-good-looking-malaysian-woman-smiling-feeling-positive_176420-44079.jpg",
        "http://img.b2bpic.net/free-photo/portrait-business-woman-with-enthusiastic-face-expression-smiling-looking-confident-standing-s_1258-127188.jpg",
        "http://img.b2bpic.net/free-photo/content-stylish-student-posing-table_23-2147666655.jpg",
        "http://img.b2bpic.net/free-photo/woman-talking-video-call-decorated-kitchen-home_482257-16862.jpg",
      ]}
      ...
      plans={[
        {
          tag: "Essentials",
          price: "$29/mo",
          description: "Unlimited laundry drops.",
          features: [
            "12 washes",
            "Same-day service",
            "Free pickup",
        ...
        },
        {
          tag: "Style & Play",
          price: "$59/mo",
          description: "Unlimited gaming + salon discount.",
          features: [
            "5 salon hours",
            "Weekly gaming",
        ...
        },
        {
          tag: "All-Access",
          price: "$99/mo",
          description: "Complete service pass.",
          features: [
            "Full laundry coverage",
  ...
  <div id="team" data-section="team">
    <SectionErrorBoundary name="team">
      ...
      groups={[
        ...
        {
          title: "Game Tech Support",
          members: [
            {
              name: "Leo K.",
              role: "Lounge Mgr",
              detail: "Hardware specialist.",
  ...
  <div id="faq" data-section="faq">
    <SectionErrorBoundary name="faq">
      ...
      items={[
        {
          question: "Are bookings required?",
          answer: "For salon yes, but laundry/games are walk-in friendly.",
        },
        {
          question: "Can I bring my own gear?",
          answer: "Yes, we encourage using your own peripherals.",
        },
        {
          question: "Is WiFi available?",
          answer: "Yes, high-speed fiber throughout the building.",
        },
        {
          question: "Do you offer dry cleaning?",
          answer: "Yes, we offer professional dry cleaning services.",
        },
      ]}
      textAnimation="fade"
    />
